...
export default function Inicio() {
  ...
  {/* Contenido principal */}
  <div className="relative z-10  items-center justify-center min-h-screen px-4 sm:px-6 md:px-8 flex flex-col gap-5">
    <div
    ...
    >
      ...
      <p className="text-white ">
        ...
        en aplicaciones a medida y sistemas de gestión. Mi pasión es crear
      ...
      <div className="flex gap-5 shadow-2xl shadow-gray-700 mt-4">
  ...
  {/* Nieve encima, pero sin bloquear interacción */}
  <Snowfall
    snowflakeCount={30}
    style={{
      position: 'fixed',
